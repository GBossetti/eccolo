const translations = {
  en: {
    ...
    'p2-title':         'The Digital Core',
    'p2-kicker':        'Your business. Your tools. Your data.',
    'p2-body':          'Generic software creates workarounds. Custom tools create flow. We build the internal systems designed around the way you and your team actually work.',
    'p2-caps':          'Private Dashboards / Custom Apps / Smart Automation',
    ...
    'proc-step3-desc':  'Going live is the beginning, not the end. We use real-world data and, more importantly, your data, to sharpen your own tools, refine your presence, and make sure your systems are always one step ahead.',
  ...
  es: {
    ...
    'p2-title':         'El Núcleo Digital',
    'p2-kicker':        'Tu negocio. Tus herramientas. Tus datos.',
    'p2-body':          'El software genérico crea soluciones parche. Las herramientas a medida crean fluidez. Construimos los sistemas internos diseñados alrededor de cómo tú y tu equipo realmente trabajan.',
    'p2-caps':          'Dashboards Privados / Apps a Medida / Automatización Inteligente',
    ...
    'proc-step3-desc':  'Salir al aire es el comienzo, no el final. Usamos datos del mundo real y, más importante aún, tus datos, para afinar tus propias herramientas, refinar tu presencia y asegurarnos de que tus sistemas siempre estén un paso adelante.',
  ...
  it: {
    ...
    'p2-title':         'Il Nucleo Digitale',
    'p2-kicker':        'Il tuo business. I tuoi strumenti. I tuoi dati.',
    'p2-body':          'Il software generico crea soluzioni di ripiego. Gli strumenti su misura creano fluidità. Costruiamo i sistemi interni progettati attorno al modo in cui tu e il tuo team lavorate davvero.',
    'p2-caps':          'Dashboard Privati / App Personalizzate / Automazione Intelligente',
  ...
  ca: {
    ...
    'p2-title':         'El Nucli Digital',
    'p2-kicker':        'El teu negoci. Les teves eines. Les teves dades.',
    'p2-body':          'El programari genèric crea solucions de pedaç. Les eines a mida creen fluïdesa. Construïm els sistemes interns dissenyats al voltant de com tu i el teu equip realment treballeu.',
    'p2-caps':          'Taulers Privats / Apps a Mida / Automatització Intel·ligent',
